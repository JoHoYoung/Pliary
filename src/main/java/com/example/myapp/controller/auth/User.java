...
public class User {
  ...
  public ResponseEntity<BaseResponse> signIn(@RequestBody Signin param) {
    ...
    final BaseResponse response = new JwtResponse(HttpStatus.OK.value(), "success", jwtService.accessToken(Session.toString()), jwtService.refereshToken(Session.toString()));
